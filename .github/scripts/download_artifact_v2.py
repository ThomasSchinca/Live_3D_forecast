...
def get_latest_successful_run(workflow_name="Part_1_bis"):
...
def get_artifact_id(run_id, artifact_name="intermediate-data_v2"):
...
def download_artifact(artifact_id, filename="intermediate-data_v2.zip"):
